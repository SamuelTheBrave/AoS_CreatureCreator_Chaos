...
function clickChar(charId) {
  ...
  if (charK.includes("ARMY") === false && charK.includes("WIZARD") === false && charK.includes("KHORNE") === false) {
    document.getElementById("validateStep" + currentTab).innerHTML = "validated";
  };
  
  document.getElementById("spe_01").setAttribute("type", "radio");
  document.getElementById("spe_02").setAttribute("type", "radio");
  document.getElementById("spe_03").setAttribute("type", "radio");
  ...
  if (charK.includes("BLOODTHIRSTER") === true) {
    ...
    //document.getElementById("spe_01").removeAttribute("type")
    document.getElementById("spe_01").setAttribute("type", "checkbox");
    document.getElementById("spe_02").setAttribute("type", "checkbox");
    document.getElementById("spe_03").setAttribute("type", "checkbox");
    
    document.getElementById("allSpells").style.display = "block";
    document.getElementById("dmgTable99check").innerHTML = "true";
    addToWS(LordOfChange_DmgTable, "damageTable", currentTab); }
  else if (charK.includes("WIZARD") === true) {
    document.getElementById("allSpells").style.display = "block"; }
  else if (charK.includes("KHORNE") === true) {
    document.getElementById("allCommandAbilities").style.display = "block"; };
};
...
function extendedAddToWS(theNameExt, wsPartExt, theTabExt, checkIdExt) {
  ...
  checkType = document.getElementById(checkIdExt).type;
  actSpellName = document.getElementById("r1_" + checkIdExt + "c1").innerHTML;
  if (currentTab == 2 && checkType == "radio") { remStepFromWS() }
  else if (checkType == "checkbox" && document.getElementById(checkIdExt).checked == false) {
    remFromWS(theNameExt, wsPartExt); };
  ...
  && charK.innerHTML.includes("LORD OF CHANGE") == false) { 
  ...
  || document.getElementById("spe_02").checked == true 
  || document.getElementById("spe_03").checked == true)
  && charK.innerHTML.includes("LORD OF CHANGE") == true) { 
    document.getElementById("rewriteSpellsCommand").innerHTML = "";
    checkSpellsCount();
    addToWS(Magic_Abi1, "magic", theTabExt);
  };
  if (document.getElementById("com_01").checked == true 
  || document.getElementById("com_02").checked == true 
  || document.getElementById("com_03").checked == true) { 
    document.getElementById("rewriteSpellsCommand").innerHTML = "";
    /*var clone = Magic_Abi0.cloneNode(true);
    clone.id = Magic_Abi0.id + "1";
    document.getElementById("rewriteSpellsCommand").appendChild(clone);
  ...
  document.getElementById("validateStep" + currentTab).innerHTML = "validated";
  if (checkType == "checkbox" && document.getElementById(checkIdExt).checked == false) {} 
  else { addToWS(theNameExt, wsPartExt, theTabExt, checkIdExt); };
};

// check how many spells are selected (Lord of Change only) ------------------------------
function checkSpellsCount() {
  var spells = ["spe_01", "spe_02", "spe_03"]
  var checkS = 0
  for (s = 0; s < spells.length; s++) { document.getElementById(spells[s]).disabled = false; };
  for (s = 0; s < spells.length; s++) {
    if (document.getElementById(spells[s]).checked == true) { checkS = checkS + 1 };
  };
  if (checkS >= 2) {
    for (s = 0; s < spells.length; s++) {
      if (document.getElementById(spells[s]).checked == false) { document.getElementById(spells[s]).disabled = true };
    };
  };
};
...
var ohWs = ["ohW_01", "ohW_02", "ohW_03", "ohW_04", "ohW_05", "ohW_06", "ohW_07", "ohW_08", "ohW_09"]
var oh2s = ["oh2_01"]
var thWs = ["thW_01", "thW_02", "thW_03", "thW_04", "thW_05", "thW_06"]
var ohMs = ["ohM_01", "ohM_02"]
var thMs = []
var shis = ["shi_01"]
...
function clickWea(checkId) {  
  ...
  if (checkId.substring(0,3) == "ohW") {    
    ...
    actWeaName = "Save";
    addTimes = 1;
    if (bStar == true && checkBox.checked == true) { 
      shi += 1;
      changeDmgTable(actWeaName, addTimes, "add"); } 
    else if (bStar == true && checkBox.checked == false) { 
      shi -= 1;
      changeDmgTable(actWeaName, addTimes, "rem"); }
    else {
      if (checkBox.checked == true) {
        shi += 1;
  ...
  switch (weaponCode) {
    ...
    case "0-200000":  //  2 different one-handed melee weapons.
      ...
      resetSecondOneHW();
      text = weaChTxt(1);  // text = "  2 different one-handed melee weapons.";     
      break;
    case "0-200100":  //  2 different one-handed melee weapons & a ranged weapon.
      weaSwitch(ohWs)  // ohWs
      for (i = 0; i < oh2s.length; i++) {document.getElementById(oh2s[i]).disabled = true;};
      for (i = 0; i < thWs.length; i++) {document.getElementById(thWs[i]).disabled = true;};
      weaSwitch(ohMs)  // ohMs
    ...
    case "0-110000":  //  2 of the same one-handed melee weapon.
      ...
      break;
    case "0-110100":  //  2 of the same one-handed melee weapon & a ranged weapon.
      weaSwitch(ohWs)  // ohWs
      weaSwitch(oh2s)  // ohWs
      for (i = 0; i < thWs.length; i++) {document.getElementById(thWs[i]).disabled = true;};
      weaSwitch(ohMs)  // ohMs
    ...
    case "0-010100":  //  2 of the same one-handed melee weapon & a ranged weapon.
      ...
      for (i = 0; i < shis.length; i++) {document.getElementById(shis[i]).disabled = false;};
      resetSecondOneHW();
      text = weaChTxt(99);  // text = "  2 of the same one-handed melee weapon & a ranged weapon.";
      break;
    case "0-100001":  //  1 one-handed melee weapon and a shield.
      ...
      break;
    case "0-100101":  //  1 one-handed melee weapon and a shield & a ranged weapon.
      weaSwitch(ohWs)  // ohWs
      for (i = 0; i < oh2s.length; i++) {document.getElementById(oh2s[i]).disabled = true;};
      for (i = 0; i < thWs.length; i++) {document.getElementById(thWs[i]).disabled = true;};
      weaSwitch(ohMs)  // ohMs
      ...
      weaSwitch(shis)  // shis
      //resetSecondOneHW();
      text = weaChTxt(3);  // text = "  1 one-handed melee weapon and a shield & a ranged weapon.";
      break;
    case "0-001000":  //  1 two-handed melee weapon.
      ...
      break;
    case "0-001100":  //  1 two-handed melee weapon & a ranged weapon.
      for (i = 0; i < ohWs.length; i++) {document.getElementById(ohWs[i]).disabled = true;};
      for (i = 0; i < oh2s.length; i++) {document.getElementById(oh2s[i]).disabled = true;};
      weaSwitch(thWs)  // thWs
      weaSwitch(ohMs)  // ohMs
    ...
    case "0-100100":  //  1 Handbow and 1 one-handed melee weapon.
      ...
      for (i = 0; i < shis.length; i++) {document.getElementById(shis[i]).disabled = false;};
      //resetSecondOneHW();
      text = weaChTxt(0);  // text = "  1 missile weapon and 1 one-handed melee weapon.";
      break;
    ...
    case "0-000001":  // only a shield.
      ...
      break;
    case "0-000101":  // only a shield & a ranged weapon.
      for (i = 0; i < ohWs.length; i++) {document.getElementById(ohWs[i]).disabled = false;};
      for (i = 0; i < oh2s.length; i++) {document.getElementById(oh2s[i]).disabled = true;};
      for (i = 0; i < ohWs.length; i++) {document.getElementById(ohWs[i]).disabled = false;};
      for (i = 0; i < thWs.length; i++) {document.getElementById(thWs[i]).disabled = true;};
      ...
      weaSwitch(shis)  // shis
      resetSecondOneHW();
      text = weaChTxt(99);  // text = "  only a shield & a ranged weapon.";
      break;
...
function resetCheckStep5_2() {
  ...
  if (document.getElementById("gaB_01").checked != true) {
    ...
    document.getElementById("bea_08").disabled = true;
  ...
  var str = document.getElementById("heroKeys").innerHTML
  if (str.includes("KHORNE") === true) { document.getElementById("bea_14").disabled = false; }
  else { document.getElementById("bea_14").disabled = true; };
  if (str.includes("TZEENTCH") === true && document.getElementById("miB_01").checked == true) { document.getElementById("bea_13").disabled = false; }
  else { document.getElementById("bea_13").disabled = true; };
...
function resetRestrictionsStep5() {
  var str = document.getElementById("heroKeys").innerHTML
  if (str.includes("GREATER DAEMON") === true) {
...
function addCharEnh(checkId) {
  ...
  switch (enhancement) {
    ...
    case "Blood Priest":
      if (checkBox.checked == true) { addKey = document.getElementById("orgKeys0" + currentTab).innerHTML + ", PRIEST"; } 
      else { addKey = document.getElementById("orgKeys0" + currentTab).innerHTML.replace(", PRIEST", ""); };
      document.getElementById("orgKeys0" + currentTab).innerHTML = addKey;
      break;
    ...
    case "Daemonic Strength":  // to wound
      statCol = 4;
      if (checkBox.id.endsWith("b")) { 
        actWeaName = wea02nam;
        actStat = wea02wnd.search("blackstar")       // check if blackstar
...
function checkAura() {
  var actStat = document.getElementById("save").innerHTML.search("blackstar");   // check if blackstar
  var bStar = false;
  var cellV = 7;
  if (actStat != -1) { bStar = true; };   // if blackstar then bStar=true and get dmgTable
  if (bStar == true) {
    ...
    if (usedCol != "") { 
      cellV = dmgTable[2].cells[usedCol].innerHTML;
      cellV = cellV.substr(0, (cellV.length - 1));
      cellV = parseInt(cellV);
    };
  }
  else { 
    cellV = document.getElementById("save").innerHTML;
    cellV = cellV.substr(0, (cellV.length - 1));
    cellV = parseInt(cellV);
  };
  
  var checkAura = document.getElementById("abi_12")   // Daemonic Aura
  var ptsAura = document.getElementById("r1_" + checkAura.id + "c8").innerHTML
  var pointCell = document.getElementById("orgPts0" + currentTab);  
  if (cellV >= 4) { checkAura.disabled = false; }
  else { 
    if (checkAura.checked == true) {
      var actPts = parseInt(pointCell.innerHTML) - parseInt(ptsAura);
      if (actPts <= 0) { pointCell.innerHTML = "0"; }
      else { pointCell.innerHTML = parseInt(pointCell.innerHTML) - parseInt(ptsAura); };
      remFromWS(Daemonic_Aura, 'abilities');   // 
      checkAura.checked = false;      
    };
    checkAura.disabled = true;
  };
...
function resetRestrictionsStep6() {
  ...
  if (str.includes("WIZARD") === false) { 
    document.getElementById("abi_04").disabled = true;
    document.getElementById("abi_05").disabled = true; };
  if (str.includes("TZEENTCH") === false) { 
    document.getElementById("abi_07").disabled = true; };
  if (str.includes("KHORNE") === true && str.includes("MORTAL") === true) { 
    document.getElementById("enh_07").disabled = false; } 
  else { document.getElementById("enh_07").disabled = true; };
  if (str.includes("KHORNE") === true && document.getElementById("moB_01").checked == true) { 
    document.getElementById("enh_10").disabled = false; } 
  else { document.getElementById("abi_10").disabled = true; };
